...
RUN apt-get -qq update && \
    apt-get -qq -y install mxe-i686-w64-mingw32.static-qt5
...
RUN printf '%s %s %s %s %s %s %s %s %s %s %s\n' \
    ...
    '"Arch":"386",' \
    '"Static":true,' \
    '"Qmake":"/usr/lib/mxe/usr/i686-w64-mingw32.static/qt5/bin/qmake",' \
    '"Moc":"/usr/lib/mxe/usr/i686-w64-mingw32.static/qt5/bin/moc",' \
    '"Rcc":"/usr/lib/mxe/usr/i686-w64-mingw32.static/qt5/bin/rcc",' \
    '"Gcc":"/usr/lib/mxe/usr/bin/i686-w64-mingw32.static-gcc",' \
    '"Gxx":"/usr/lib/mxe/usr/bin/i686-w64-mingw32.static-g++",' \
    '"Windres":"/usr/lib/mxe/usr/bin/i686-w64-mingw32.static-windres"' \
